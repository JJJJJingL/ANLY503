...
# Datasets (3. Data used for analysis (raw data))
There are 7 datasets used in this project (Birth Ra
...
# Code Instruction (1. All the development file(s), 2. Code)
...
# Output file (3. Data used for analysis (wrangled datasets))
...
# Screenshots file (5.Clear screenshots of your visualization(s))

# Visualizations (4.Data visualization(s))
...
# Slides (6.Your slides and any other presentation material)
